...
fileID <- data.frame(id     = 'invasives',
                     year   = 2013,
                     link   = "https://knb.ecoinformatics.org/knb/d1/mn/v2/object/raw_2013_invasives_mol_20150714093653",
                     export = "raw_2013_invasives_mol.zip",
                     stringsAsFactors = F)
...
invasives <- crop(invasives, ext)

# Copy raster values to memory to that export is done properly
values(invasives) <- values(invasives)
